...
class SnacksTests(TestCase):
    def setUp(self):
      ...
      Snacks.objects.create(name="apple", purchaser=purchaser, description="yummy snacks")
    ...
    def test_list_page_context(self):
        ...
        self.assertEqual(snacks[0].name, "apple")
        self.assertEqual(snacks[0].description, "yummy snacks")
    ...
    def test_detail_page_context(self):
        ...
        self.assertEqual(snacks.name, "apple")
        self.assertEqual(snacks.description, "yummy snacks")
